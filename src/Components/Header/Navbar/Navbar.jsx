            ...
            <nav className="bg-white my-4 border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
...

                        {
                            ...
                            user ? <>
                                ...
                                : <Link to={"/login"}>
                                    ...
                                    <button type="button" className="text-white bg-pink-500 font-medium rounded-lg  px-4 py-2 ">Login</button>
                    ...
                    <div className="items-center justify-between  w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        ...
                        <li>
                            <NavLink className="block py-2 pl-3 pr-4 text-white bg-pink-500 rounded md:bg-transparent md:text-pink-500 md:p-0 md:dark:text-pink-500">Home</NavLink>
                        </li>
                            <li>
                                <NavLink to={'/about'} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-pink-500 md:p-0 md:dark:hover:text-pink-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About Us </NavLink>
                            </li>
                            <li>
                                <NavLink to={'/services'} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-pink-500 md:p-0 md:dark:hover:text-pink-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</NavLink>
                            </li>
                            <li>
